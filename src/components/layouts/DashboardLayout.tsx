...
const DashboardContent: React.FC<DashboardLayoutProps> = ({ children }) => {
  ...
  useEffect(() => {
    const baseMenu: MenuItem[] = [
      ...
      { title: "Google Classroom", shortTitle: "Class", path: "/classroom", icon: GraduationCap },
